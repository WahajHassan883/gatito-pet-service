...
function NavBar() {
  return (
    <nav className="flex flex-col gap-4 px-4 py-4 sm:items-center sm:justify-between md:flex-row">
      ...
      <div className="flex w-full flex-col items-center gap-4 rounded-xl bg-red-600 p-4 sm:flex-row sm:justify-between md:ml-6 md:mt-5 md:w-[512px] md:items-center md:gap-6 md:rounded-full md:px-6 md:py-4">
        {/* Logo */}
